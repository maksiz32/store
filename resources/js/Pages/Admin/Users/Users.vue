...
let openEditFormClients = ref(false);
...
<template>
    ...
    <div class="store-users__table">
        ...
        <Modal :show="openEditForm" :closeable="true" @close="openEditForm = false">
            <Register
                :closable="true"
                @closeRegister="openEditForm = false"
                :isMustAdmin="true"
                :isAdminMode="true"
            />
        </Modal>
        <v-btn
            color="success"
            class="mb-2"
            @click="openEditFormClients = true"
        >
            Add Client
        </v-btn>
        <Modal :show="openEditFormClients" :closeable="true" @close="openEditFormClients = false">
            <Register
                :closable="true"
                @closeRegister="openEditFormClients = false"
                :isMustAdmin="false"
                :isAdminMode="true"
            />
        </Modal>
